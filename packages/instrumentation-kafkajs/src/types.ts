...
export const types = interface KafkaProducerCustomAttributeFunction {
    (span: Span, topic: string, message: Message): void;
};

export const types = interface KafkaConsumerCustomAttributeFunction {
    (span: Span, topic: string, message: Message): void;
};

export const types = interface KafkaJsInstrumentationConfig extends InstrumentationConfig {
