...
export const suppressTracing = const suppressTypeormInternalTracing = (context: Context) =>
    context.setValue(SUPPRESS_TYPEORM_INTERNAL_TRACING_KEY, true);

export const suppressTracing = const isTypeormInternalTracingSuppressed = (context: Context) =>
